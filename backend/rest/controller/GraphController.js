...
module.exports = {
    ...
    async searchUserId(req, res) {
        try {
            ...
            var user = await getUserData(entityId, token);
            var domain = user.data.usuario.domain;
                ...
                if (issuer['0'] !== '0') {
                    ...
                    for (var j = 1; j < quantidade_badges; j++) {
                        ...
                        for (var k = 1; k < quantidade_assertions; k++) {
                            ...
                            console.log("--->", assertion_items);
                            console.log("--->", entityId);

                            if (badgeClass['1'] === assertion_items['5']) {
                                if (assertion_items['1'] !== "") {

                                    if (assertion_items['6'] === entityId) {
                                        issuer_identificado.push({
                                            id: assertion_items['1'],
                                            parentId: assertion_items['5'],
                                            name: "Badge recebido",
